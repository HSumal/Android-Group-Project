...
public class Flight implements Serializable {
  ...
  private static final long serialVersionUID = -7108317864109029742L;
// initialize private variables for Flight Class.
  ...
  /**
   * sets the number of available seats of the flight to newNum.
   * @param newNum is the new number of available seats
   */
  public void setNumSeats(int newNum) {
  ...
  /**
   * decreases the number of available seats on the flight by 1.
   */
  ...
  /**
   * Increments the number of available seats on the flight by 1.
   */
  public void flightUnbooked() {
    this.numSeats += 1;
  }
  
  /**
   * returns true iff numSeats is 0, false o/w.
   * @return true iff numSeats is 0, false o/w
   */
